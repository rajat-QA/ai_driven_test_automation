...
## Knowledge Sources
Read all the files from `./eventhub-domain` folder before creating scenarios. Use the domain skill to understand the business rules and flows.
...
## Output Format
Write to **`docs/test-scenarios_copilot.md`** (consumed by `/test-strategy` skill). Use this template:
